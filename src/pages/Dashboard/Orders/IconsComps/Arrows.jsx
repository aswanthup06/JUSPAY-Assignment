...
const SvgArrows = (props) => (
  ...
  >
    ...
    <path
      fill="#1C1C1C"
      d="M5.625 3.75v12.5a.625.625 0 1 0 1.25 0V3.75a.625.625 0 1 0-1.25 0M15.808 6.692a.626.626 0 0 0 .884-.884l-2.5-2.5a.625.625 0 0 0-.884 0l-2.5 2.5a.625.625 0 1 0 .884.884l2.058-2.058z"
    />
    <path
      fill="#1C1C1C"
